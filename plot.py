...
<<<<<<< HEAD
# Time-stamp: <2016-02-16 11:42:47 marine>
=======
# Time-stamp: <2016-02-16 09:54:51 marine>
>>>>>>> 46ec5e5b98fc37fdb06a4a95d742d32e1ce0f0ad
...
if __name__ == '__main__':
    ...
    with open(out_folder+basename+"-output.txt", 'r') as f:
    first_line = f.readline()
    print first_line
    
    # Append text in a file
    with open(out_folder+"test.txt", "a") as myfile:
